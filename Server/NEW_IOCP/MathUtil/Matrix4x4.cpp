...
Matrix4x4::Matrix4x4(float _11, float _12, float _13, float _14, float _21, float _22, float _23, float _24, float _31,
                     float _32, float _33, float _34, float _41, float _42, float _43, float _44) :
    XMFLOAT4X4(_11, _12, _13, _14, _21, _22, _23, _24, _31, _32, _33, _34, _41, _42, _43, _44)
{
}

Matrix4x4::Matrix4x4(const XMFLOAT4X4 &matrix) :
    XMFLOAT4X4(matrix)
{
}
...
{
    return *this * Rotate(other);
}

Matrix4x4 Matrix4x4::operator*(const XMFLOAT4X4 &other) const
{
    XMFLOAT4X4 result;
...
bool Matrix4x4::operator==(const XMFLOAT4X4 &other) const
{
...
{
    XMFLOAT4X4 result;
    XMStoreFloat4x4(&result, XMMatrixInverse(nullptr, XMLoadFloat4x4(this)));
    return result;
}
...
Vector4 Matrix4x4::GetRow(int index) const
{
    ...
    case 2:
        return {_12, _22, _32, _42};
    case 3:
        return {_13, _23, _33, _43};
    case 4:
        return {_14, _24, _34, _44};
    default:
