...
Vector4::Vector4(const DirectX::XMFLOAT4& vec) : XMFLOAT4(vec)
{
}
...
Vector4 Vector4::operator+(const DirectX::XMFLOAT4& other) const
{
	XMFLOAT4 result;
...
Vector4& Vector4::operator+=(const DirectX::XMFLOAT4& other)
{
	*this = *this + other;
	return *this;
}
...
bool Vector4::operator==(const DirectX::XMFLOAT4& other) const
{
