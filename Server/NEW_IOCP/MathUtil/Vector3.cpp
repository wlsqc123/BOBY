...
Vector3::Vector3(const XMFLOAT3 &vec) :
    XMFLOAT3(vec)
{
}
...
Vector3 Vector3::RotateTowards(const Vector3 &current, const Vector3 &target, float max_radians_delta,
                               float max_magnitude_delta)
{
