...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
	...
	while (true)
	{
		...
		{
			gGameFramework.FrameAdvance();				//프레임 경과시 실행
		}
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	SetWindowPos(hMainWnd, NULL, screenWidth / 2 - (rc.right - rc.left) / 2, screenHeight / 2 - (rc.bottom - rc.top) / 2, rc.right - rc.left, rc.bottom - rc.top, 0);
