...
Matrix4x4::Matrix4x4(const aiMatrix4x4& aimatrix)
	: Matrix4x4(aimatrix.a1, aimatrix.a2, aimatrix.a3, aimatrix.a4,
...
Matrix4x4 Matrix4x4::operator+(const DirectX::XMFLOAT4X4& other) const
{
	XMFLOAT4X4 result;
	XMStoreFloat4x4(&result, XMLoadFloat4x4(this));
	result._11 += other._11;
	result._12 += other._12;
	result._13 += other._13;
	result._14 += other._14;
	result._21 += other._21;
	result._22 += other._22;
	result._23 += other._23;
	result._24 += other._24;
	result._31 += other._31;
	result._32 += other._32;
	result._33 += other._33;
	result._34 += other._34;
	result._41 += other._41;
	result._42 += other._42;
	result._43 += other._43;
	result._44 += other._44;
	return result;
}
